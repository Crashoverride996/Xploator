...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "boost-1.82.0"
  WORKING_DIRECTORY "/home/supre/Desktop/Projects/C++/Xploator/build/_deps/boost-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: boost-1.82.0")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/supre/Desktop/Projects/C++/Xploator/build/_deps/boost-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/supre/Desktop/Projects/C++/Xploator/build/_deps/boost-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
